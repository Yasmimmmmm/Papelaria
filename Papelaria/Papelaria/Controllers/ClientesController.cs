...
namespace Papelaria.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,Nome,Endereço,Telefone,CPF,Email,Nascimento")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ClienteId,Nome,Endereço,Telefone,CPF,Email,Nascimento")] Cliente cliente)
        {
